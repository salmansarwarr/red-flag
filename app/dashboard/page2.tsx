            ...
            <header className="border-b bg-background/95 backdrop-blur supports-[backdrop-filter]:bg-background/60">
                <div className="container flex h-16 items-center gap-4 px-4 md:px-6">
                    ...
                    <nav className="hidden md:flex flex-1 items-center gap-4 md:gap-6">
                        ...
                        <Button variant="ghost" size="sm">
                            <Flag className="h-4 w-4 mr-2" /> My Flags
                        </Button>
                        <DropdownMenu>
                            ...
                            <Dialog>
                                <DialogTrigger asChild>
                                    <Button className="w-full" size="lg">
                                        <Flag className="mr-2 h-5 w-5" /> Flag
                                        Someone
                                    </Button>
                                </DialogTrigger>
                                <DialogContent>
                                    <DialogHeader>
                                        ...
                                        <DialogDescription>
                                            Search for a profile or paste a
                                            LinkedIn URL to flag someone.
                                        </DialogDescription>
                                    </DialogHeader>
                    ...
                    <div className="md:col-span-3">
                        <Card className="p-6 mb-6">
                            ...
                            <div className="space-y-4">
                                ...
                                <Button className="w-full">
                                    <Coins className="mr-2 h-4 w-4" /> Get More
                                    Tokens
                                </Button>
                            </div>
                        </Card>
